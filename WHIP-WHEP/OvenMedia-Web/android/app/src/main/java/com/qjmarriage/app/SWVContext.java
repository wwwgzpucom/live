...
public class SWVContext {
    ...
    public static void loadConfig(Context context) {
        ...
        // --- URL Configuration ---
        ASWV_APP_URL = config.getString("app.url", "https://qjmarriage.com/");
        ...
        ASWV_EXC_LIST = config.getString("external.url.exception.list", "");
        ...
        USER_AGENT_POSTFIX = config.getString("agent.postfix.value", "QjMarriage");
        ...
        // --- Plugins & Permissions ---
        ASWP_ENABLED_PLUGINS = config.getStringArray("plugins.enabled", new String[]{"JSInterfacePlugin","ToastPlugin","QRScannerPlugin","BiometricPlugin","ImageCompressionPlugin"});
    ...
    public static void loadPlugins(Context context) {
        ...
        String[] pluginClasses = {
            "com.qjmarriage.app.plugins.BiometricPlugin",
            "com.qjmarriage.app.plugins.ClipboardPlugin",
            "com.qjmarriage.app.plugins.DialogPlugin",
            "com.qjmarriage.app.plugins.GeolocationCachePlugin",
            "com.qjmarriage.app.plugins.ImageCompressionPlugin",
            "com.qjmarriage.app.plugins.JSInterfacePlugin",
            "com.qjmarriage.app.plugins.LocationPlugin",
            "com.qjmarriage.app.plugins.NetworkInfoPlugin",
            "com.qjmarriage.app.plugins.QRScannerPlugin",
            "com.qjmarriage.app.plugins.RatingPlugin",
            "com.qjmarriage.app.plugins.SharePlugin",
            "com.qjmarriage.app.plugins.ToastPlugin"
        };
    ...
    public static final Map<Integer, NavItem> ASWV_DRAWER_MENU = new HashMap<Integer, NavItem>() {{
        put(R.id.nav_home, new NavItem(R.id.nav_home, "https://qjmarriage.com/"));
    }};
}