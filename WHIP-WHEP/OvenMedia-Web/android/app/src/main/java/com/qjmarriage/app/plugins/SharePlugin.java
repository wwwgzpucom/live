...
public class SharePlugin implements PluginInterface {
    ...
    private void shareText(String text, String subject, String chooserTitle) {
        ...
        Intent chooser = Intent.createChooser(send, chooserTitle != null && !chooserTitle.isEmpty() ? chooserTitle : activity.getString(R.string.share_w_friends));
    ...
    private void shareFile(String uriString, String mimeType, String caption, String chooserTitle) {
        ...
        try {
            ...
            Intent chooser = Intent.createChooser(send, chooserTitle != null && !chooserTitle.isEmpty() ? chooserTitle : activity.getString(R.string.share_file_via));
            chooser.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            activity.startActivity(chooser);
        } catch (Exception e) {
